...
# -*- coding: latin-1 -*-
#
# File    : RPCplus_Flashing_AfterSales_mit_Vflash.py
# Title   : RPCplus_Flashing_AfterSales_mit_Vflash
# Task    : RPCplus AfterSales Flashing mit vFlash Tools
#
...
# ------------------------------------------------------------------------------
# 1.0  | 26.04.2022 | Mohammed | initial
# 1.2  | 12.05.2022 | Mohammed  | Added Testschritte
# 1.3  | 22.07.2022 | Mohammed  | Added Raumtemperatur zwischen -40 to 90 Grad
# ******************************************************************************
...
try:
    ...
    try:
        ...
        testresult.append(["\x0a RPCplus AfterSales Flashing: SW 0111 Erfolgreich", "PASSED"])
