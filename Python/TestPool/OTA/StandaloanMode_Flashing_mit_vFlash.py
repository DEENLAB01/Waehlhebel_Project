...
try:
    ...
    flash_file_path = r"C:\Users\DEENLAB01\Desktop\Software_version\SW0112\Vflash_Project\Production_Key\ISO\Project1.vflash" ## must be ISOCAN via vFlash
    ...
    try:
        ...
        testresult.append(["\x0aStandaLoanMode Flashing: SW0112 Erfolgreich", "PASSED"])
