...
# -*- coding: latin1 -*-
# File    : E2E_72.py
# Title   : ORU_Control_A_Timeout_Normal
# Task    : Erstmalige Timeout-Fehlererkennung ORU_Control_A_01 während "Normal"  und Heilung
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_72")
    ...
    hil.ORU_Control_A_01__period.set(0)

    # test step 3
    testresult.append(["[.] Warte  4500ms  (Qualifikation Zeit für Timeout DTC eintrag = n-q+ 1= 10-2+1= 9 fehlende Botschaft im FIFO  )", ""])
    time.sleep(4.500 + 0.220)
    ...
    # test step 5
    testresult.append(["[.] Lese Fehlerspeicher (0xE00107 DTC aktiv)", ""])
