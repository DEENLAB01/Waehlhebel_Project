...
# Task    : Einzelne BZ-Fehler unterhalb der Toleranzschwelle, die bei unterschiedlichen Signalen auftreten, aber in Summe zu einem Fehler führen würden, müssen ignoriert werden.
#
...
try:
    ...
    # test step 5
    testresult.append(["[.] Sende ORU_Control_A_01_BZ Fehler für 3500ms (7 Zyklen)", ""])
    ...
    # test step 8
    testresult.append(["[.] Sende ORU_Control_D_01_BZ Fehler für 2240ms (7 Zyklen)", ""])
    ...
    # test step 11
    testresult.append(["[.] Sende OTAMC_D_01_BZ Fehler für 2240ms (7 Zyklen)", ""])
