...
# -*- coding: latin1 -*-
# File    : E2E_39.py
# Title   : SiShift_CRC_Error_Repeat
# Task    : Mehrmalige Fehlererkennung SiShift_01_CRC und Wechsel aus "Safe State" in den Zustand "Safe State Permanent".
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_39")
