...
# Task    : Erstmalige Timeout-Fehlererkennung  SiShift_01 während "Normal"  und Heilung
#
...
try:
    ...
    # test step 3
    testresult.append(["[.] Warte  260ms (Qualifikation Zeit für Timeout DTC eintrag = n-q+ 1= 14-2+1= 13 fehlende Botschaft im FIFO  ). ", ""])
