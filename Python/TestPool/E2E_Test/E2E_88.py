...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_88")
    ...
    # test step 3
    testresult.append(["[.] Warte 2 Zyklen lang (2x20=40ms)", ""])
    time.sleep(0.040)

    # test step 4
    testresult.append(["[.]  Sende einmal SiShift_01_20ms_CRC Fehler (Wechsel nach Safe State)", ""])
    sec = 0.027
    timeout = sec + t()
    CRC_value = hil.SiShift_01__SiShift_01_20ms_CRC__value.get()
    hil.SiShift_01__SiShift_01_20ms_CRC__value.set(1)
    while timeout > t():
        hil.SiShift_01__SiShift_01_20ms_CRC__value.set(1)
    hil.SiShift_01__SiShift_01_20ms_CRC__value.set(CRC_value)

    # test step 5
    testresult.append(["[.] Warte 20ms", ""])
    time.sleep(0.020)
    ...
    # test step 7
    testresult.append(["[.] Warte weitere 12 Zyklen lang (insgesamt Qualifikationszeit für BZ Failure DTC Eintrag = n-q+ 1= 14 fehlende Botschaften im FIFO) ", ""])
    time.sleep(0.020 * 12 + 0.020)
