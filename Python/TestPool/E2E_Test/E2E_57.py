...
# -*- coding: latin1 -*-
# File    : E2E_57.py
# Title   : OTAMC_D_BZ_Error_Init
# Task    : Erstmalige Fehlererkennung OTAMC_D_01_BZ während "Initialized"
#
...
# 1.3  | 26.10.2022 | Devangbhai   | Added 200ms in test step 1.1 for tDiagStart, Change the wait time in test step 4
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_57")
    ...
    # test step 4
    testresult.append(["[.] Warte 320ms (1st ist gültige Botschaft)+ 160ms (Jitter)Warte 2880ms (n-q +1 Botschaft im FIFO =10-2+1= 9*320ms = 2880ms). ", ""])
    time.sleep(0.320 + 2.880 + 0.160)

    # test step 5
    checkProgrammingPrecondition(exp_content=[0xA7], ticket_id="EGA-PRM-288")
