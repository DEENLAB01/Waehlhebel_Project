...
# -*- coding: latin1 -*-
# File    : E2E_75.py
# Title   : OTAMC_D_Timeout_Normal
# Task    : Erstmalige Timeout-Fehlererkennung OTAMC_D_01 während "Normal" und Heilung
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_75")
    ...
    # test step 1
    testresult.append(["[.] Schaltle Kl30 und Kl15 und RBS ein und warte 2500ms s", ""])
    hil.cl15_on__.set(1)
    ...
    # test step 2
    testresult.append(["[-] Setze OTAMC_D_01 zyklus zeit auf  0ms.", ""])
    hil.OTAMC_D_01__period.set(0)
    ...
    # test step 6
    testresult.append(["[.] Setze OTAMC_D_01 zyklus zeit auf 320ms und  warte 2560ms+ 160ms Toleranze (3 + n/2 gültige signal im FIFO)", ""])
    hil.OTAMC_D_01__period.set(320)
