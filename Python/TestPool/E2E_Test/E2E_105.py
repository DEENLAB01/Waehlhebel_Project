...
# -*- coding: latin1 -*-
# File    : E2E_105.py
# Title   : SiShift_BZ_Error_Timeout_Qualification2
# Task    : 3 BZ-Fehler und 2 Timeoutfehler werden gleichzeitig beaufschlagt. Dabei ist der häufiger erkannte Fehler zu qualifizieren und im Ereignisspeicher einzutragen.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_105")
    ...
    # test step 2
    testresult.append(["[-] Sende 3 SiShift_01_BZ failure und 2 SiShift_01_BZ timeout error.", ""])
    ...
    # test step 4
    testresult.append(["[.] Sende 3 SiShift_01_BZ failure", ""])
    hil.SiShift_01__period.set(20)
    time.sleep(0.070+ 0.020)
