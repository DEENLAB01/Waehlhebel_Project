...
# -*- coding: latin1 -*-
# File    : E2E_64.py
# Title   : ORU_Control_A_Timeout_Init
# Task    : Erstmalige Timeout-Fehlererkennung ORU_Control_A_01 während "Initialized"
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_64")
    ...
    testresult.append(canape_diag.checkEventMemory(aktiv_dtc, ticket_id="EGA_PRM_271"))
