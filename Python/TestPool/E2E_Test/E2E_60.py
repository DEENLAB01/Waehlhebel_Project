...
# -*- coding: latin1 -*-
# File    : E2E_60.py
# Title   : OTAMC_D_BZ_Error_Diag_Suppressed
# Task    : Erstmalige Fehlererkennung OTAMC_D_01_BZ während "Initialized" bei ausgeblendeter Diagnose.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_60")
