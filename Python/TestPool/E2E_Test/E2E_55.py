...
# -*- coding: latin1 -*-
# File    : E2E_55.py
# Title   : ORU_Control_A_BZ_Error_Init
# Task    : Erstmalige Fehlererkennung ORU_Control_A_01_BZ während "Initialized"
#
...
# 1.2  | 26.10.2022 | Devangbhai   | Added 200ms in test step 1.1 for tDiagStart, Change the wait time in test step 4
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("E2E_55")
