# ******************************************************************************
# -*- coding: latin1 -*-
# File    : Timeout_VDSO_05_NWDF.py
# Title   : Timeout_VDSO_05_NWDF
# Task    : DTC 0xE00104 Timeouterkennung VDSO_05 und Ablage im Fehlerspeicher abhängig von NWDF.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_432")
    ...
    # test step 3
    testresult.append(["[.] Setze  VDSO_05 Zykluszeit auf 0.", ""])
