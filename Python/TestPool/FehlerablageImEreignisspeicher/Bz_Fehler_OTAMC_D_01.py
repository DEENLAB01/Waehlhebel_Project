...
# -*- coding: latin-1 -*-
#
# File    : Bz_Fehler_OTAMC_D_01.py
# Title   : Bz_Fehler_OTAMC_D_01
# Task    : Fehlererkennung für BZ-Fehler OTAMC_D_01 und Ablage im Fehlerspeicher
...
try:
    ...
    wait_time = 1500
    activ_dtcs = [(0xE0010C, 0x27)]
    passive_dtcs = [(0xE0010C, 0x26)]

    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_197")
    ...
    testresult.append(canape_diag.checkEventMemory(activ_dtcs, ticket_id='FehlerId:EGA-PRM-236'))
