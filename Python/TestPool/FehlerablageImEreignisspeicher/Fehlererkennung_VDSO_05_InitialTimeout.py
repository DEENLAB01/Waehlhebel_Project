# ******************************************************************************
# -*- coding: latin1 -*-
# File    : Fehlererkennung_VDSO_05_InitialTimeout.py
# Title   : Fehlererkennung_VDSO_05_InitialTimeout
# Task    : DTC 0xE00104 Timeouterkennung VDSO_05 und Ablage im Fehlerspeicher
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_423")
    ...
    # test step 4
    testresult.append(["[.] Setze Zykluszeit der Botschaft VDSO_05 auf 0 ms", ""])
    ...
    # making sure that the System info signal was received
    hil.Systeminfo_01__period.set(2)
    hil.Systeminfo_01__period.setState("an")

    # test step 6
    testresult.append(["[.] Warte 500ms + 200 ms ", ""])
