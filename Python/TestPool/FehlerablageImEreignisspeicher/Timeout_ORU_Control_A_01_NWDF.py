# ******************************************************************************
# -*- coding: latin1 -*-
# File    : Timeout_ORU_Control_A_01_NWDF.py
# Title   : Timeout_ORU_Control_A_01_NWDF
# Task    : DTC 0xE00107 Timeouterkennung ORU_Control_A_01 und Ablage im Fehlerspeicher abhängig von NWDF.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_427")
    ...
    # test step 9
    testresult.append(["[.] Warte 4000ms.", ""])
    time.sleep(4)
    ...
    # test step 11
    testresult.append(["[.] Warte 500ms + 250ms.", ""])
    time.sleep(0.500 + 0.250)
