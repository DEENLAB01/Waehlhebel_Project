# ******************************************************************************
# -*- coding: latin1 -*-
# File    : Fehlerablage_Netzwerkdiagnosefreigabe_Kl15Wechsel.py
# Title   : Fehlerablage_Netzwerkdiagnosefreigabe_Kl15Wechsel
# Task    : DTC 0xE00107 Netzwerkdiagnosefreigabe bei Klemmenwechsel
#
...
try:
    ...
    passiv_dtc_unterspannung = [(0x800100, 0x26), (0x800101, 0x27)]

    aktiv_dtc_ORUA_TO = [(0xE00107, 0x27)]

    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_435")
    ...
    # test step 4
    testresult.append(["[.] Setze Kl.15 auf 0.", ""])
    hil.cl15_on__.set(0)
    ...
    # test step 7
    testresult.append(["[.] Setze Kl.15 auf 1.", ""])
    hil.cl15_on__.set(1)
    ...
    # test step 12
    testresult.append(["[.] Warte 2000ms (4500ms - 2500ms= 2000ms) +250ms sampling cycle time", ""])
