...
# -*- coding: latin-1 -*-
#
# File    : Timeout_ORU_Control_D_01.py
# Title   : Timeout_ORU_Control_D_01
# Task    : Timeouttest of HIL-Tx => ECU-Rx Signals of CAN Message ORU_Control_D_01
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_195")
    ...
    # test step 5
    testresult.append(["[.] Warte 2880ms (tMSG_Timeout: n-q+1, n=10, q=2) + 200ms (Tollerenz)", ""])
    time.sleep(2.880 + 0.200)
    ...
    # test step 8
    testresult.append(["[.] Setze Zykluszeit der Botschaft ORU_Control_D_01 auf 320ms (original)", ""])
    period_var.set(cycle_time)

    # test step 9
    testresult.append(["[.] Warte 2560 ms (tMSG_Timeout: n/2, n=10, q=2) + 320ms (Tolerenz)", ""])
