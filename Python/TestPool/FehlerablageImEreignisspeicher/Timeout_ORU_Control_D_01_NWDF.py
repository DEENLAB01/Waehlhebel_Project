# ******************************************************************************
# -*- coding: latin1 -*-
# File    : Timeout_ORU_Control_D_01_NWDF.py
# Title   : Timeout_ORU_Control_D_01_NWDF
# Task    : DTC 0xE00108 Timeouterkennung ORU_Control_D_01 und Ablage im Fehlerspeicher abhängig von NWDF.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_428")
    ...
    # test step 3
    testresult.append(["[.] Setze  ORU_Control_D_01 Zykluszeit auf 0.", ""])
