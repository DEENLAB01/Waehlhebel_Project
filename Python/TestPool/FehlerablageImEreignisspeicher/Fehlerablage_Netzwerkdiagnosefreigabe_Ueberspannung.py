# ******************************************************************************
# -*- coding: latin1 -*-
# File    : Fehlerablage_Netzwerkdiagnosefreigabe_Ueberspannung.py
# Title   : Fehlerablage_Netzwerkdiagnosefreigabe_Ueberspannung
# Task    : DTC 0xE00107 Netzwerkdiagnosefreigabe bei Überspannung
#
...
# 1.1  | 03.11.2022 | Devangbhai   | Added 20ms tolerance in the test step 5 according to change in the test spec.
...
try:
    ...
    aktiv_dtc_unterspannung = [(0x800100, 0x27), (0x800101, 0x27)]
    passiv_dtc_unterspannung = [(0x800100, 0x26), (0x800101, 0x26)]

    aktiv_dtc_ORUA_TO = [(0xE00107, 0x27)]

    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_434")
    ...
    # test step 4
    testresult.append(["[.] Setze KL30 Spannung (NWDF ungültiger Bereich): 17V + 0,34 (2% Toleranz) + 0,03V (HiL Toleranz) = 17,37V", ""])
    hil.vbat_cl30__V.set(17.37)

    # test step 5
    testresult.append(["[.] Warte 520ms", ""])
    time.sleep(0.520)

    # test step 6
    testresult.append(["[.] Lese Fehlerspeicher aus", ""])
    testresult.append(canape_diag.checkEventMemory(aktiv_dtc_unterspannung))
    ...
    # test step 9
    testresult.append(["[.] Lese Fehlerspeicher aus", ""])
    testresult.append(canape_diag.checkEventMemory(passiv_dtc_unterspannung))
    ...
    # test step 12
    testresult.append(["[.] Warte 2000ms (4500ms - 2500ms= 2000ms) + 250ms", ""])
    time.sleep(2.000 + 0.250 )

    # test step 13
    testresult.append(["[.] Lese Fehlerspeicher aus", ""])
    testresult.append(canape_diag.checkEventMemory(passiv_dtc_unterspannung + aktiv_dtc_ORUA_TO))
