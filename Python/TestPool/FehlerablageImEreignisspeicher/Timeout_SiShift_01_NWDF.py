# ******************************************************************************
# -*- coding: latin1 -*-
# File    : Timeout_SiShift_01_NWDF.py
# Title   : Timeout_SiShift_01_NWDF
# Task    : DTC 0xE00101 Timeouterkennung SiShift_01 und Ablage im Fehlerspeicher abhängig von NWDF.
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_430")
    ...
    # test step 3
    testresult.append(["[.] Setze  SiShift_01 Zykluszeit auf 0.", ""])
    hil.SiShift_01__period.setState("aus")

    # test step 4
    testresult.append(["[.] Warte 280ms (tMSG_Timeout)", ""])
    time.sleep(0.280)
