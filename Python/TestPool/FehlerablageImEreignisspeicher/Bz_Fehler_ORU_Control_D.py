...
# -*- coding: latin-1 -*-
#
# File    : Bz_Fehler_ORU_Control_D.py
# Title   : Bz-Fehler_ORU_Control_D
# Task    : Fehlererkennung für BZ-Fehler ORU_Control_D und Ablage im Fehlerspeicher
...
# 1.3  | 29.07.2022 | Mohammed | Added TestStep 11.9 and 11.10
# 1.4  | 16.08.2022 | Mohammed | Added Tollerenz
...
try:
    ...
    wait_time = 1500
    activ_dtcs = [(0xE0010B, 0x27)]
    passive_dtcs = [(0xE0010B, 0x26)]
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_392")
    ...
    # test step 1
    testresult.append(["[.] Setze Zykluszeit der Botschaft ORU_Control_D_01 auf 320ms " ""])
    ...
    # test step 4
    testresult.append(["[.] Halte ORU_Control_D_01:ORU_Control_D_01_BZ an (Setze Inkrementierung des Botschaftszählers aus)", ""])
    ...
    time.sleep(2.880 + 0.300)

    # test step 6
    testresult.append(["[.] Lese Fehlerspeicher (0xE0010B DTC activ)", ""])
    testresult.append(canape_diag.checkEventMemory(activ_dtcs, ticket_id='FehlerId:EGA-PRM-235'))
    ...
    # test step 8
    testresult.append(["[.] Setze ORU_Control_D_01:ORU_Control_D_01_BZ  wieder fort)", ""])
    ...
    # test step 10
    testresult.append(["[.] Lese Fehlerspeicher (0xE0010B DTC passiv)", ""])
