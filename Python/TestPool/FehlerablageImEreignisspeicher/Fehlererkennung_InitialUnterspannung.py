# ******************************************************************************
# -*- coding: latin1 -*-
# File    : Fehlererkennung_InitialUnterspannung.py
# Title   : Fehlererkennung_InitialUnterspannung
# Task    : DTC 0x800102 Initiale Unterspannungserkennung und Ablage im Fehlerspeicher
#
...
try:
    ...
    aktiv_dtc = [(0x800100, 0x27), (0x800102, 0x27)]
    passiv_dtc = [(0x800100, 0x26), (0x800102, 0x27)]

    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_425")
    ...
    # test step 4
    testresult.append(["[.]  Setze KL30 Spannung (ungültiger Bereich): 5,7V - 0,114V (2% Toleranz) - 0,03V (HiL Toleranz) = 5,556V", ""])
    hil.vbat_cl30__V.set(5.556)
    ...
    # send voltage read request
    # testresult.append(["[.] Schalte Kl.15 ein und starte RBS und warte bis erste NM Botschaft empfängt", ""])
    # request = [0x22] + [0xF1, 0xF2]
    # [response, result1] = canape_diag.sendDiagRequest(request)
    ...
    testresult.append(canape_diag.checkEventMemory(aktiv_dtc, ticket_id="EGA-PRM-297"))
