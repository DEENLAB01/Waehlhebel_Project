...
# -*- coding: latin-1 -*-
#
# File    : einmal_Bz_Fehler_ORU_Control_D.py
# Title   : einmal_Bz_Fehler_ORU_Control_D
# Task    : Fehlererkennung einamal BZ-Fehler ORU_Control_D und Ablage im Fehlerspeicher
...
# 1.5  | 02.11.2022 | Devangbhai | Added 3 more cycle wait in test step 7
#******************************************************************************
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_394")
