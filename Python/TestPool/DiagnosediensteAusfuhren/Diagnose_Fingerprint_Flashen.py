# ******************************************************************************
# -*- coding: latin-1 -*-
# File    : Diagnose_Fingerprint_Flashen.py
...
# 1.4  | 25.07.2022 | Mohammed     | Rework
# ******************************************************************************
# Imports #####################################################################
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("TestSpec_335")
    ...
    testresult.append(["[.] In die Extended Session wechseln und Warte 1 Sekunde", ""])
    ...
    testresult.append(["[.] beim Standard-Flashvorgang mit vFlash in der entsprechenden Maske :Tester Serial Number",
                       ""])
    ...
    testresult.append(["[.]  Fingerprint And Programming Date Of Logical Software Blocks' auslesen: [0xF1, 0x5B]", ""])
    ...
    write_value1 = [0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x22, 0x11, 0x02, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x00]
    testresult.append(["[.] Prüfe Inhalt der Response", ""])
    expected_response = [0x62] + [0xF1, 0x5B] + write_value1
    testresult.append(canape_diag.checkResponse(response1, expected_response))
