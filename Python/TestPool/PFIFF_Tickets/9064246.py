# ******************************************************************************
# -*- coding: latin1 -*-
# File    : BZ_jumps_SiShift.py
# Title   : BZ_jumps_SiShift
# Task    : BZ jumps SiShift
#
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("349579_02")
    ...
    # test step 1.1
    testresult.append(["[+] Warte 3s", ""])
    time.sleep(3)

    testresult.append(["[-] Set the voltage to 5v", ""])
    hil.vbat_cl30__V.set(5.0)

    testresult.append(["[.]  Stop RBS", ""])
    func_nm.hil_ecu_e2e(allstate=0, sisft=0, otamc=0, oruA=0, ourD=0)

    testresult.append(["[.]  Wait 800ms", ""])
    time.sleep(0.800)

    testresult.append(["[-] Set the voltage to 13v", ""])
    ...
    #         break
    # bz_ = [5, 12, 3, 8, 5, 6, 11, 8, 9, 14, 11, 12, 1, 14, 15, 4, 1, 6, 7, 12, 8, 9]
    #
    # for i in bz_:
