...
# Task    : Wiederholte Fehlererkennung SiShift_01_CRC und Wechsel nach "Safe State Permanent". Heilung in diesem Zustand ist nicht möglich.
#
...
try:
    ...
    # test step 2
    testresult.append(["[-] Sende zweimal hintereinander CRC-Error für SiShift_01", ""])
    sec = 0.039
    timeout = sec + t()
    ...
    # test step 3
    testresult.append(["[.]  Warte t =15ms (sampling cycle time = 10ms+ 5ms tolerenze für WH_04 message)", ""])
    time.sleep(0.015)
    ...
    # test step 10
    testresult.append(["[.] Werte Wählhebel_04 Botschaft erneut aus", ""])
    testresult.append(
        basic_tests.checkStatus(
            current_status=hil.Waehlhebel_04__WH_Fahrstufe__value.get(),
            nominal_status=15,
