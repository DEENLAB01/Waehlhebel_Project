...
# ------------------------------------------------------------------------------
# 1.0  | 22.09.2022 | Devangbhai   | initial
...
try:
    ...
    # set Testcase ID #########################################################
    testresult.setTestcaseId("345479_ORU_A")
    ...
    # test step 3
    testresult.append(["[.] Setze ORU_Control_A_01 zyklus zeit auf 0ms ", ""])
    hil.ORU_Control_A_01__period.setState("aus")

    # test step 4
    testresult.append(["[.] Warte 4500ms (n -q +1 Botschaft im FIFO =10-2 +1 = 9*500ms = 4500ms). ", ""])
    time.sleep(4.5+ 0.200)

    testresult.append(["[.] Setze Systeminfo_01__period zyklus zeit auf 0ms ", ""])
    ...
    # test step
    testresult.append(["[.]  warte 7000ms", ""])
    time.sleep(7)

    testresult.append(["[.] Lese Fehlerspeicher (0xE00106 DTC aktiv)", ""])
    testresult.append(canape_diag.checkEventMemory( [(0xE00106, 0x27)]))

    testresult.append(["[.] Warte 4500ms (n -q +1 Botschaft im FIFO =10-2 +1 = 9*500ms = 4500ms). ", ""])
    time.sleep(4.5 + 0.200)

    testresult.append(["[.] Lese Fehlerspeicher (0xE00106 DTC aktiv)", ""])
    testresult.append(canape_diag.checkEventMemory([(0xE00106, 0x27), (0xE0010A, 0x27)]))
